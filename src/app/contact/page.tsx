          ...
          <div className="faq-right rv sr" data-d="1">
            <div className="faq-list">
              <div className={`faq-item ${openFaqIndex === 0 ? 'open' : ''}`}>
                ...
                <div className="faq-a" style={{ maxHeight: openFaqIndex === 0 ? '500px' : '0', transition: 'max-height 0.45s var(--ease)' }}>
              ...
              <div className={`faq-item ${openFaqIndex === 1 ? 'open' : ''}`}>
                ...
                <div className="faq-a" style={{ maxHeight: openFaqIndex === 1 ? '500px' : '0', transition: 'max-height 0.45s var(--ease)' }}>
                  <div className="faq-a-inner">
              ...
              <div className={`faq-item ${openFaqIndex === 2 ? 'open' : ''}`}>
                ...
                <div className="faq-a" style={{ maxHeight: openFaqIndex === 2 ? '500px' : '0', transition: 'max-height 0.45s var(--ease)' }}>
                  <div className="faq-a-inner">
              ...
              <div className={`faq-item ${openFaqIndex === 3 ? 'open' : ''}`}>
                ...
                <div className="faq-a" style={{ maxHeight: openFaqIndex === 3 ? '500px' : '0', transition: 'max-height 0.45s var(--ease)' }}>
                  <div className="faq-a-inner">
              ...
              <div className={`faq-item ${openFaqIndex === 4 ? 'open' : ''}`}>
                ...
                <div className="faq-a" style={{ maxHeight: openFaqIndex === 4 ? '500px' : '0', transition: 'max-height 0.45s var(--ease)' }}>
                  <div className="faq-a-inner">
              ...
              <div className={`faq-item ${openFaqIndex === 5 ? 'open' : ''}`}>
                ...
                <div className="faq-a" style={{ maxHeight: openFaqIndex === 5 ? '500px' : '0', transition: 'max-height 0.45s var(--ease)' }}>
                  <div className="faq-a-inner">
