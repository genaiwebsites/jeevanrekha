    ...
    <section id="view-blog-post" className="view-section post-main active">
      ...
      <div className="post-layout">
        ...
        <div className="post-content rv sl" data-d="1">
          <img src="/blogs/avoid-these-myths-about-rice-bran-oil-in-india.png" alt="Avoid these Myths about Rice Bran Oil in India - Jeevan Rekha Foods" className="post-img" loading="lazy" />
