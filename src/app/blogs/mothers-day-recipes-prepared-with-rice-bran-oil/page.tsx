    ...
    <>
      ...
      <div className="post-layout">
        ...
        <div className="post-content" data-d="1">
          <Image
            src="/blogs/mothers-day-recipes-prepared-with-rice-bran-oil.png"
            alt="Mothers Day Recipes prepared with Rice Bran Oil - Jeevan Rekha Foods"
            width={1200}
            height={630}
          ...
          <div className="blog-takeaway-card" style={{
            ...
            <p style={{ margin: 0, fontSize: '1.1rem', lineHeight: '1.7', fontStyle: 'italic', color: 'var(--h)', letterSpacing: '-0.01em' }}>"Show your mother how much she means to you with 5 healthy, home-cooked recipes. Prepared using physically refined Rice Bran Oil — rich in Gamma-Oryzanol and Vitamin E — these dishes balance restaurant-quality flavors with heart-healthy nutrition."</p>
          </div>
