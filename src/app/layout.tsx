...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://jeevanrekhafoods.com/og/og_homepage.jpg',
        secureUrl: 'https://jeevanrekhafoods.com/og/og_homepage.jpg',
        width: 1200,
        height: 630,
        type: 'image/jpeg',
        alt: 'Jeevan Rekha Premium Edible Oils Product Range Banner',
      },
      {
        url: 'https://jeevanrekhafoods.com/og/square/sq_homepage.jpg',
        secureUrl: 'https://jeevanrekhafoods.com/og/square/sq_homepage.jpg',
        width: 800,
        height: 800,
        type: 'image/jpeg',
        alt: 'Jeevan Rekha Premium Edible Oils Product Range Thumbnail',
      },
    ],
  },
  twitter: {
